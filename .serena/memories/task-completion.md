...
4. **Conventions:** Ensure new code follows .cursorrules (repository, server-routes, vue-pages-components, general). Use existing patterns in repository/, server/routes/, and components/.
