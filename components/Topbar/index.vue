...
.topbar-bg {
	@apply w-full h-20 md:h-16 flex justify-between md:justify-end items-center px-4 bg-gradient-to-b from-secondary-600 to-main-600 md:bg-white md:bg-none;
}
