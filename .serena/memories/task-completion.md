...
5. **Shared code:** If adding enums, constants, or types used by both portal and backend, add them in yeppi-common and import in the portal; do not duplicate in app/utils or repository models when they belong in common.
