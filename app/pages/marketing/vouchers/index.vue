<template>
	<ZPagePanel id="vouchers-listing" :title="$t('nav.vouchers')" back-to="/marketing">
		<template #navbar-right>
			<ZCreateButton to="/marketing/vouchers/create" :label="$t('common.addVoucher')" />
		</template>
		<template #toolbar>
...
useHead({ title: () => t('pages.vouchersTitle') });
