...
export const Routes = {
	...
	Orders: {
		...
		Export: () => `${API_PATH.MERCHANT}/${API_PATH.ORDERS}/export`,
	},
	Sales: {
		...
		Export: () => `${API_PATH.MERCHANT}/${API_PATH.SALES}/export`,
	},
	SummOrders: {
		Dashboard: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/dashboard`,
		Orders: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}`,
		Export: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/export`,
		Items: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/items`,
		ExportItems: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/items/export`,
		Customers: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/customers`,
		ExportCustomers: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_ORDERS}/customers/export`,
	},
	SummSales: {
		Dashboard: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/dashboard`,
		Sales: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}`,
		Export: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/export`,
		Items: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/items`,
		ExportItems: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/items/export`,
		Payments: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/payments`,
		ExportPayments: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/payments/export`,
		Customers: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/customers`,
		ExportCustomers: () => `${API_PATH.MERCHANT}/${API_PATH.SUMM_SALES}/customers/export`,
	},
	PaymentTypes: {
	...
	Outlets: {
		Create: () => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/`,
		Many: () => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/`,
		Single: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/${code}`,
		Update: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/${code}`,
		Delete: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/${code}`,
		Restore: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.OUTLETS}/restore/${code}`,
	},
	Taxes: {
		Create: () => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/`,
		Many: () => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/`,
		Single: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/${code}`,
		Update: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/${code}`,
		Delete: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/${code}`,
		Restore: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAXES}/restore/${code}`,
	},
	TaxGroups: {
		Create: () => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/`,
		Many: () => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/`,
		Single: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/${code}`,
		Update: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/${code}`,
		Delete: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/${code}`,
		Restore: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_GROUPS}/restore/${code}`,
	},
	TaxRules: {
		Create: () => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/`,
		Many: () => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/`,
		Single: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/${code}`,
		Update: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/${code}`,
		Delete: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/${code}`,
		Restore: (code: string) => `${API_PATH.MERCHANT}/${API_PATH.TAX_RULES}/restore/${code}`,
	},
};
