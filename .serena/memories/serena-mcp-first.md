...
For wemotoo-portal, the workspace rule **serena-mcp-first.mdc** requires:

- **Activate project first:** Use `mcp_serena_activate_project` with project `wemotoo-portal` when starting work on the portal.
