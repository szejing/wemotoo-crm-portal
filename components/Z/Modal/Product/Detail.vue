<template>
	...
	>
		<UCard>
			...
			<UForm :schema="UpdateProductValidation" :state="state" class="space-y-4" @submit="onSubmit">
				<!-- *********************** General Info *********************** -->
				<ZInputProductGeneralInfo
					...
					v-model:subtitle="state.subtitle"
				...
				<!-- *********************** Pricing *********************** -->
				<div v-for="(price, index) in state.price_types" :key="index">
